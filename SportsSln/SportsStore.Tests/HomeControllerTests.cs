...
public class HomeControllerTests
{
	...
	public void CanFilterProducts() {
		...
		// Act
		var result = ((controller.Index("Cat2", 1) as ViewResult)?.ViewData.Model as ProductsListViewModel)
						?.Products.ToArray();
	...
	public void GenerateCategorySpecificProductCount() {
		...
		static ProductsListViewModel GetModel(IActionResult result) => (result as ViewResult)?.ViewData?.Model as ProductsListViewModel;
